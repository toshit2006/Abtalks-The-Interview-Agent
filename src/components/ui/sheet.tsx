...
interface SheetContentProps
  ...
  /** Set to false to omit the built-in absolutely-positioned close button
   *  (e.g. when the consumer renders its own close button inside a proper
   *  header instead, to avoid overlapping content). Defaults to true. */
  showClose?: boolean;
}
